	...
	$(document).on("click","#randBtn", function() {
		$.ajax({
			...
			success : function(data) {
				...
				var src= "images/portfolio/item-"+(Math.floor(Math.random()*6)+1)+".jpg"
...
<section id="works" class="works">
	<div class="section-heading">
		<h1 class="title wow fadeInDown" data-wow-delay=".3s" style="margin-top : 30px">
			Today House
		</h1>
     	...
     	<div class="col-md-7 col-sm-5">
            ...
            >
              ...
              <figcaption>
                ...
                <p><span id="price">15,000</span>만원  / <span id="location">역삼동</span></p>
              </figcaption>
            </figure>
          </div>
     </div>
