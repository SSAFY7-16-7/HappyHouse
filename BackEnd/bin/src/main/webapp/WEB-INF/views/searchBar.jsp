...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ff39ee8d511b533648d3baac6dd7efff&libraries=services"></script>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="block">
					<div class="search_div subtitle-des wow fadeInUp animated"
						data-wow-delay=".5s" data-wow-duration="500ms">
						...
						<form id="frm">
							...
							<input name="word" id="name" type="text" placeholder="아파트 이름 입력"  class="search_comp"/> 
