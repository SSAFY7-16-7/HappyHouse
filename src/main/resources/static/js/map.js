...
function displayInfowindow(marker, title, place) {
	var content = `
		<div class="overlaybox">
			...
			<div class="first"><img src="${root}/images/logo.png" style="width:247px; height:136px;" alt=""></div>
			<ul>
				<li>
				<span class="title">최신거래금액</span>
				<span class="count">${place.dealYear}.${place.dealMonth}.${place.dealDay}</span>
				</li>
				
				<li>
				<span class="title">거래 날짜 </span>
				<span class="count">${place.dealAmount}원 </span>
				</li>
			</ul>
