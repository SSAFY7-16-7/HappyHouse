				...
				<div class="form">
					<form name="register-form" class="register-form" method="post"
						...
						<input type="hidden" name="act" id="act" value="modify"> <input
							id="id" name="id" value="${userInfo.id}" type="text"
							placeholder="id" /> <input id="password"
							value="${userInfo.password}" name="password" type="password"
							placeholder="password" /> <input id="email"
							value="${userInfo.email}" name="email" type="email"
							placeholder="email address" /> <input id="name" name="name"
							value="${userInfo.name}" type="text" placeholder="name" /> <input
							id="age" name="age" value="${userInfo.age}" type="text"
							placeholder="age" />
